...
new Float:police_garage[][] = {
	...
	{ 480.0833, -1766.2258, 5.1111, 180.7847 },// Пляж
...
new Float:police_garage_enter[][] = {
	...
	{475.2915,-1762.0549,5.5234,356.5913},
...
hook OnGameModeInit() {
	...
	CreateDynamic3DTextLabel(""cBLUE"[ Служебный гараж ]",C_BLUE, 480.0980,-1761.9863, 6.5,10.0,INVALID_PLAYER_ID,INVALID_VEHICLE_ID,1, -1,-1);
